...
// Run2 implements the main program loop of the demo. It returns when the platform signals to stop.
func Run2(p Platform, r Renderer) {
	imgui.CurrentIO().SetClipboard(clipboard{platform: p})
	...
	for !p.ShouldStop() {
		...
		{
			imgui.Text("Hello, William!")                // Display some text
